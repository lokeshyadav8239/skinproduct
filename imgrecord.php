    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td>
                  <button class="btn btn-primary"><a href="imgedit.php?id=<?php echo $rows['id']; ?>">Edit</a> </button>
               <button class="btn btn-danger"><a href="imgdelete.php?id=<?php echo $rows['id']; ?>">Delete</a> </button>
