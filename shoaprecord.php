    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td><button class="btn btn-info"><a href="shoapedit.php?id=<?php echo $rows['id']; ?>">Edit</a> </button>
                    <button class="btn btn-danger"><a href="shoapdelete.php?id=<?php echo $rows['id']; ?>">Delete</a> </button> 
