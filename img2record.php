    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td>
                  <button class="btn btn-primary"><a href="img2edit.php?id=<?php echo $rows['id']; ?>">Edit</a> </button>
               <button class="btn btn-danger"><a href="img2delete.php?id=<?php echo $rows['id']; ?>">Delete</a> </button>
