...
$id=$_GET['id'];
  ...
  $sql = "select * from shoap where id=$id"; 
      ...
      <li class="write"><a href=" imgrecord.php">image record </a></li>
       <li class="write"><a href=" img2.php">img2</a></li>
        <li class="write"><a href=" img2record.php">img2 record </a></li>
          <li class="write"><a href=" shoap.php">shoap</a></li>
            <li class="write"><a href=" shoaprecord.php">shoaprecord</a></li>
  </ul>
</nav>
...
<main role="main">
  ...
  <section class="panel important">
    <h2>Edit a category</h2>
      ...
      <form action="shoapinsertedit.php" method="post" enctype="multipart/form-data">
  ...
  ?>
        <input type="hidden" name="id" value="<?php echo $values['id']; ?>" />
         ...
         <div class="twothirds">
           Blog title:<br/>
          <input type="text" name="title" value="<?php echo $values['title']; ?>" size="40"/><br/><br/>
           <div class="twothirds">
          Image:<br/>
          <input type="file" name="image" size="40"/><br/><br/> 
           <input type="hidden" name="image" value="<?php echo $values['image'] ?>"  size="40"/><br/><br/>
