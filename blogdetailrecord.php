    ...
    <table> 
        ...
        <tbody> 
            ...
            <tr> 
                ...
                <td><button class="btn btn-info"><a href="blogdetailedit.php?id=<?php echo $rows['id']; ?>">Edit</a> </button>
                    <button class="btn btn-primary"><a href="blogdetailview.php?id=<?php echo $rows['id']; ?>">View</a> </button> 
                  <button class="btn btn-danger"><a href="blogdetaildelete.php?id=<?php echo $rows['id']; ?>">Delete</a> </button> 
